...
Create `~/Library/LaunchAgents/com.sai.caddy-webdav.plist`:
...
<dict>
    <key>Label</key>
    <string>com.sai.caddy-webdav</string>
...
```bash
launchctl load ~/Library/LaunchAgents/com.sai.caddy-webdav.plist
launchctl start com.sai.caddy-webdav
```
...
```bash
launchctl stop com.sai.caddy-webdav
launchctl start com.sai.caddy-webdav
```
...
```bash
launchctl unload ~/Library/LaunchAgents/com.sai.caddy-webdav.plist
```
