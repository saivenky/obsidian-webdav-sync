...
The next charge is ~April 2, 2026 — cancel before then.
...
- `~/Library/LaunchAgents/com.sai.caddy-webdav.plist` loaded and running
...
1. Take your Mac **offline** (disable Tailscale or `launchctl stop com.sai.caddy-webdav`).
...
1. Stop Caddy: `launchctl stop com.sai.caddy-webdav`
...
4. Restart Caddy: `launchctl start com.sai.caddy-webdav`
